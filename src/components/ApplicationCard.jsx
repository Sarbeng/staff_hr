...
export default function ApplicationCard ({to, icon, heading, onClick, Style, iconStyle}) {
    return <>
        <Link to={to}>
        <button className="bg-primary-main hover:bg-white text-white hover:text-primary-main shadow-sm p-8 border border-primary-border rounded-lg w-56" onClick={onClick}>
